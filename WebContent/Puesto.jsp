...
<form action="<%=request.getContextPath()%>/Puesto" method="post" >
	<input class="boton_personalizado" type="submit" value="Consultar" title="Consultar Puesto" alt="Consultar Puesto" style="width:100px; height:25px">
...
<form action="<%=request.getContextPath()%>/Puesto" method="post">
	<input class="boton_personalizado" type="submit" value="Actualizar" title="Actualizar Puesto" alt="Actualizar Puesto" style="width:100px; height:25px">
...
<form action="<%=request.getContextPath()%>/Puesto" method="post">
	<input class="boton_personalizado" type="submit" value="Alta" title="Alta Puesto" alt="Alta Puesto" style="width:100px; height:25px">
