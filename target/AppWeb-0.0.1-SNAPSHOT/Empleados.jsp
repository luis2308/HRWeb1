...
<form action="<%=request.getContextPath()%>/Empleados" method="post" >
	<input class="boton_personalizado" type="submit" value="Consultar" title="Consultar Empleados" alt="Consultar Empleados" style="width:100px; height:25px">
...
<form action="<%=request.getContextPath()%>/Empleados" method="post">
	<input class="boton_personalizado" type="submit" value="Actualizar" title="Actualizar Empleados" alt="Actualizar Empleados" style="width:100px; height:25px">
...
<form action="<%=request.getContextPath()%>/Empleados" method="post">
	<input class="boton_personalizado" type="submit" value="Alta" title="Alta Empleados" alt="Alta Empleados" style="width:100px; height:25px">
<input type="hidden" id="alta" name="opcion" value="registra">
</form>
...
<input type="hidden" id="elimina" name="opcion" value="elimina"></form>
<br>
<form action="<%=request.getContextPath()%>/Empleados" method="post">
