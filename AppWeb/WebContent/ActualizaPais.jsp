...
<table>
	<tr>
		<td><label for="Name">ID Pais:</label> <br> </td> 
		<td><input type="text" size="30" maxlength="30"  name="id_pais" > </td>
	</tr>
</table>
...
%>
	<tr>
		<td><label for="Name">Id Pais:</label> <br> </td> 
		<td><input type="text" size="30" maxlength="30"  name="id_pais" value=<%=lista.get(i).getIdPais() %> readonly="readonly"> </td>
	</tr>
	<tr>
	...
	<tr>
		<td><label for="Name">Id Region:</label> </td> 
		<td><input type="text" size="30" maxlength="30"  name="region" value=<%=lista.get(i).getIdRegion()%>> </td> 
	</tr>
